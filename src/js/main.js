...
document.addEventListener('DOMContentLoaded', function () {
    ...
    debounceTimer = setTimeout(function() {
        if (window.scrollY > navbar.getBoundingClientRect().height || navbarToggler.getAttribute('aria-expanded') === 'true') {
    ...
    document.addEventListener('click', function(event) {
      ...
      if (!isClickInsideNavbar && navbarToggler.getAttribute('aria-expanded') === 'true') {
        navbarToggler.click();
      }
    });
